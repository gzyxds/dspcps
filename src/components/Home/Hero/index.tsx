			...
			<div className='mx-auto w-full max-w-[740px] px-4 text-center sm:px-8 xl:px-0'>
				...
				<div className='flex justify-center gap-8 mb-8'>
					<div className='text-center transition-transform hover:scale-105'>
						...
						<p className='mt-2 text-sm font-medium'>扫码关注</p>
					</div>
					<div className='text-center transition-transform hover:scale-105'>
						<div className='rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow'>
							<Image
						...
						<p className='mt-2 text-sm font-medium'>联系客服</p>
					</div>
					<div className='text-center transition-transform hover:scale-105'>
						<div className='rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow'>
							<Image
						...
						<p className='mt-2 text-sm font-medium'>加入社群</p>
					</div>
				</div>
				...
				>
					<span> APP下载 </span>
					<span className='inline-flex h-9 w-9 items-center justify-center rounded-full bg-green-500 text-white dark:bg-green-500 dark:text-white'>
						<svg
							className='fill-current'
							width='20'
							height='20'
